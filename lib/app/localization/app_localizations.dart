...
const Map<String, Map<String, String>> _values = <String, Map<String, String>>{
  'en': <String, String>{
    ...
    'hi': 'Hi',
    'setsCountHint':
        'Plan the sets and an optional target reps for each. Weights are recorded during the workout, never here.',
    'monthlyReport': 'Monthly report',
    'noWorkoutsThisMonth': 'No workouts this month.',
    'workoutsCount': 'Workouts',
    'exerciseOf': 'Exercise %1 of %2',
    'target': 'Target',
    'completeExercise': 'Complete Exercise',
    'upNext': 'Up Next',
    'allExercisesDone': 'All exercises completed!',
    'emptyExerciseWarning':
        'Enter at least one set before completing this exercise.',
  ...
  'ar': <String, String>{
    ...
    'hi': 'أهلاً',
    'setsCountHint':
        'خطط الدفعات وحدد عدّات هدف لكل دفعة (اختياري). الوزن بينسجّل وقت التمرين، مو هون.',
    'monthlyReport': 'التقرير الشهري',
    'noWorkoutsThisMonth': 'لا يوجد تمارين هذا الشهر.',
    'workoutsCount': 'عدد التمارين',
    'exerciseOf': 'تمرين %1 من %2',
    'target': 'الهدف',
    'completeExercise': 'إنهاء هذا التمرين',
    'upNext': 'التمارين الجاية',
    'allExercisesDone': 'خلصت كل التمارين!',
    'emptyExerciseWarning': 'سجّل دفعة وحدة عالأقل قبل إنهاء التمرين.',
    'finishEarly': 'إنهاء التمرين بشكل مبكر',
